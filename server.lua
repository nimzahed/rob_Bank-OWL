...
outputChatBox("#FF0000Bayad "..hadaghaltedadpd.." ta police hadaghal bashe!" , source , 255 , 0 , 0 , true)
end
end
end
end
...
outputChatBox("#FF0000Too Marker Rob Nisti!" , player , 255 , 0 , 0 , true)
return false
end
